 ...
 */
router.get('/:id/tickets', validateRequest({
  params: {
 ...
 */
router.put('/:id/assign', validateRequest({
  params: {
    id: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 */
router.put('/:id/unassign', validateRequest({
  params: {
    id: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req, res, next) => {
 ...
 */
router.get('/teams/:teamId/metrics', validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req, res, next) => {
 ...
 */
router.get('/dashboard/metrics', validateRequest({
  query: {
