 ...
 */
router.post('/tickets/:ticketId/email', validateRequest({
  params: {
 ...
 */
router.post('/tickets/:ticketId/notify', validateRequest({
  params: {
    ticketId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 */
router.post('/email/templates', validateRequest({
  body: {
 ...
 * GET /email/templates
 */
router.get('/email/templates', validateRequest({
  query: {
  ...
  try {
    ...
    const templates = activeOnly === 'true' 
 ...
 */
router.get('/email/templates/:templateId', validateRequest({
  params: {
 ...
 */
router.put('/email/templates/:templateId', validateRequest({
  params: {
    templateId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 */
router.delete('/email/templates/:templateId', validateRequest({
  params: {
    templateId: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
router.post('/email/templates/:templateId/render', validateRequest({
  params: {
    templateId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 */
router.get('/email/template-variables', async (_req: Request, res: Response, next: NextFunction) => {
  try {
