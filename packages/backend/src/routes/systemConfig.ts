 ...
 */
router.get('/settings/:category', authenticate, requireAdmin, validateRequest({
  params: {
 ...
 */
router.put('/settings', authenticate, requireAdmin, validateRequest({
  body: {
    settings: {
      type: 'array',
      required: true,
 ...
 */
router.delete('/settings/:key', authenticate, requireAdmin, validateRequest({
  params: {
    key: { type: 'string', required: true },
  },
}), async (req: Request, res: Response) => {
 ...
 */
router.post('/config/import', authenticate, requireAdmin, validateRequest({
  body: {
