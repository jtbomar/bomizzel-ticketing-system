 ...
 */
router.post('/:ticketId/notes', validateRequest({
  params: {
 ...
 */
router.get('/:ticketId/notes', validateRequest({
  params: {
    ticketId: { type: 'string', required: true, format: 'uuid' },
  },
  query: {
 ...
 * GET /notes/:noteId
 */
router.get('/notes/:noteId', validateRequest({
  params: {
 ...
 * PUT /notes/:noteId
 */
router.put('/notes/:noteId', validateRequest({
  params: {
    noteId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 * DELETE /notes/:noteId
 */
router.delete('/notes/:noteId', validateRequest({
  params: {
    noteId: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req: Request, res: Response, next: NextFunction) => {
 ...
 * GET /notes/search
 */
router.get('/notes/search', validateRequest({
  query: {
 ...
 */
router.get('/:ticketId/notes/history', validateRequest({
  params: {
    ticketId: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
router.post('/notes/:noteId/attachments/:attachmentId', validateRequest({
  params: {
    noteId: { type: 'string', required: true, format: 'uuid' },
 ...
 */
router.delete('/notes/:noteId/attachments/:attachmentId', validateRequest({
  params: {
    noteId: { type: 'string', required: true, format: 'uuid' },
    attachmentId: { type: 'string', required: true, format: 'uuid' },
  },
 ...
 */
router.get('/notes/:noteId/attachments', validateRequest({
  params: {
    noteId: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req: Request, res: Response, next: NextFunction) => {
