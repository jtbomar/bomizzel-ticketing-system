 ...
 */
router.get('/:teamId', authenticate, validateRequest({
  params: {
 ...
 */
router.post('/', authenticate, requireRole(['admin']), validateRequest({
  body: {
 ...
 */
router.put('/:teamId', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 * Get team members
 */
router.get('/:teamId/members', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req: Request, res: Response) => {
 ...
 */
router.post('/:teamId/members', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 */
router.delete('/:teamId/members/:userId', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
    userId: { type: 'string', required: true, format: 'uuid' },
  },
 ...
 */
router.put('/:teamId/members/:userId/role', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
    userId: { type: 'string', required: true, format: 'uuid' },
  },
