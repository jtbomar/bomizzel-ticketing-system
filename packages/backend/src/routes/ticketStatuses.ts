 ...
 */
router.get('/:teamId/statuses', authenticate, validateRequest({
  params: {
 ...
 */
router.post('/:teamId/statuses', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 */
router.put('/:teamId/statuses/:statusId', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
 ...
 */
router.delete('/:teamId/statuses/:statusId', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
    statusId: { type: 'string', required: true, format: 'uuid' },
  },
 ...
 */
router.put('/:teamId/statuses/reorder', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
  },
  body: {
 ...
 */
router.get('/:teamId/statuses/stats', authenticate, validateRequest({
  params: {
    teamId: { type: 'string', required: true, format: 'uuid' },
  },
}), async (req: Request, res: Response) => {
