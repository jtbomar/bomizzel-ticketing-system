...
router.post('/seed-business-hours', authenticate, authorize('admin'), async (req, res, next) => {
  try {
    ...
    for (const company of companies) {
      ...
      const existing = await db('business_hours')
      ...
      const [bhId] = await db('business_hours').insert({
      ...
      const schedule = [
        ...
        { day_of_week: 1, is_working_day: true, start_time: '09:00:00', end_time: '17:00:00', break_start: '12:00:00', break_end: '13:00:00' },
        { day_of_week: 2, is_working_day: true, start_time: '09:00:00', end_time: '17:00:00', break_start: '12:00:00', break_end: '13:00:00' },
        { day_of_week: 3, is_working_day: true, start_time: '09:00:00', end_time: '17:00:00', break_start: '12:00:00', break_end: '13:00:00' },
        { day_of_week: 4, is_working_day: true, start_time: '09:00:00', end_time: '17:00:00', break_start: '12:00:00', break_end: '13:00:00' },
        { day_of_week: 5, is_working_day: true, start_time: '09:00:00', end_time: '17:00:00', break_start: '12:00:00', break_end: '13:00:00' },
...
router.post('/seed-holiday-lists', authenticate, authorize('admin'), async (req, res, next) => {
  try {
    ...
    for (const company of companies) {
      ...
      const existing = await db('holiday_lists')
        .where('company_id', company.id)
        .first();
      ...
      // Create holiday list
      const [listId] = await db('holiday_lists').insert({
        company_id: company.id,
      ...
      await db('holidays').insert(
        holidays.map(h => ({ ...h, holiday_list_id: id }))
      );
