...
exports.up = function (knex) {
  return knex.schema
    .createTable('holiday_lists', function (table) {
    ...
    .then(() => {
      return knex.schema.createTable('holidays', function (table) {
        table.increments('id').primary();
        table
          .integer('holiday_list_id')
          .unsigned()
          .references('id')
          .inTable('holiday_lists')
          .onDelete('CASCADE');
...
exports.down = function (knex) {
  return knex.schema
    .dropTableIfExists('business_hours_holiday_lists')
