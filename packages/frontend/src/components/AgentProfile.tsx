...
const AgentProfile: React.FC<AgentProfileProps> = ({
  ...
  const [localBoardSettings, setLocalBoardSettings] = useState(
    boardSettings || {
      autoRefresh: true,
      dragAndDrop: true,
                ...
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src =
                      `https://ui-avatars.com/api/?name=${encodeURIComponent(profileData.firstName + ' ' + profileData.lastName)}&size=96&background=3b82f6&color=ffffff`;
                  }}
                />
                <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        Automatically refresh ticket data
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        Enable drag and drop for tickets
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        Show priority adjustment arrows
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setLocalBoardSettings((prev) => ({
                            ...prev,
                            showPriorityArrows: e.target.checked,
                          }))
                        }
                      />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        Display who tickets are assigned to
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    description: 'Notify when your tickets are updated',
                  },
                ].map((pref) => (
