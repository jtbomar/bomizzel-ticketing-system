        ...
        <div className="p-6">
                      ...
                      <ul className="space-y-1 text-sm text-gray-600">
                        <li className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {formatLimit(plan.limits.activeTickets)}
                          </span>
                        </li>
                        <li className="flex justify-between">
                          <span>Completed Tickets:</span>
                          <span className="font-medium">
                            {formatLimit(plan.limits.completedTickets)}
                          </span>
                        </li>
                        <li className="flex justify-between">
                          <span>Total Tickets:</span>
                          <span className="font-medium">
                            {formatLimit(plan.limits.totalTickets)}
                          </span>
                        </li>
                      </ul>
                    </div>
          ...
          <div className="mt-8 bg-gray-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-3">
              All plans include full access to our ticketing system with real-time updates, file
              attachments, and email integration. Higher tiers provide more capacity and advanced
