...
const CompanyManagement: React.FC = () => {
  ...
  const [filters, setFilters] = useState<CompanyFilters>({ search: '' });
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-medium text-white">
          Company Management
          {companies.length > 0 && (
            <span className="ml-2 text-sm text-white/60">({companies.length} total)</span>
          )}
        </h2>
        <button
        ...
        {companies.map((company) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/60">{company.domain || 'No domain'}</p>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center text-sm">
              {company.customerCount !== undefined && (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-white/60">
            {filters.search
              ...
              : 'Companies will appear here when they sign up'}
          </p>
        </div>
      )}
