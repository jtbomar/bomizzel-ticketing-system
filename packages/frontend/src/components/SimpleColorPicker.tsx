  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-sm text-gray-700 dark:text-gray-300">{displayInfo.name}</span>
          ...
          <div className="absolute top-full left-0 mt-1 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-20 w-72">
            ...
            <div className="mb-3">
              ...
              <div className="flex space-x-2">
                ...
                <div
                  ...
                  style={{
                    backgroundColor: /^#[0-9A-Fa-f]{6}$/.test(hexInput) ? hexInput : '#cccccc',
                  }}
                />
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(to bottom, #ffffff, #000000), linear-gradient(to right, #ff0000, #ffff00, #00ff00, #00ffff, #0000ff, #ff00ff, #ff0000)',
