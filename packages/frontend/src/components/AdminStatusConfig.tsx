...
const AVAILABLE_COLORS = [
  // Primary Colors
  { name: 'Red', value: 'red', bg: 'bg-red-500', preview: 'bg-red-100 text-red-800 border-red-200' },
  { name: 'Orange', value: 'orange', bg: 'bg-orange-500', preview: 'bg-orange-100 text-orange-800 border-orange-200' },
  { name: 'Yellow', value: 'yellow', bg: 'bg-yellow-500', preview: 'bg-yellow-100 text-yellow-800 border-yellow-200' },
  { name: 'Green', value: 'green', bg: 'bg-green-500', preview: 'bg-green-100 text-green-800 border-green-200' },
  { name: 'Blue', value: 'blue', bg: 'bg-blue-500', preview: 'bg-blue-100 text-blue-800 border-blue-200' },
  
  // Secondary Colors
  { name: 'Purple', value: 'purple', bg: 'bg-purple-500', preview: 'bg-purple-100 text-purple-800 border-purple-200' },
  { name: 'Pink', value: 'pink', bg: 'bg-pink-500', preview: 'bg-pink-100 text-pink-800 border-pink-200' },
  { name: 'Teal', value: 'teal', bg: 'bg-teal-500', preview: 'bg-teal-100 text-teal-800 border-teal-200' },
  { name: 'Indigo', value: 'indigo', bg: 'bg-indigo-500', preview: 'bg-indigo-100 text-indigo-800 border-indigo-200' },
  { name: 'Cyan', value: 'cyan', bg: 'bg-cyan-500', preview: 'bg-cyan-100 text-cyan-800 border-cyan-200' },
  
  // Extended Colors
  { name: 'Emerald', value: 'emerald', bg: 'bg-emerald-500', preview: 'bg-emerald-100 text-emerald-800 border-emerald-200' },
  { name: 'Lime', value: 'lime', bg: 'bg-lime-500', preview: 'bg-lime-100 text-lime-800 border-lime-200' },
  { name: 'Amber', value: 'amber', bg: 'bg-amber-500', preview: 'bg-amber-100 text-amber-800 border-amber-200' },
  { name: 'Rose', value: 'rose', bg: 'bg-rose-500', preview: 'bg-rose-100 text-rose-800 border-rose-200' },
  { name: 'Violet', value: 'violet', bg: 'bg-violet-500', preview: 'bg-violet-100 text-violet-800 border-violet-200' },
  
  // Neutral Colors
  { name: 'Slate', value: 'slate', bg: 'bg-slate-500', preview: 'bg-slate-100 text-slate-800 border-slate-200' },
  { name: 'Gray', value: 'gray', bg: 'bg-gray-500', preview: 'bg-gray-100 text-gray-800 border-gray-200' },
  { name: 'Zinc', value: 'zinc', bg: 'bg-zinc-500', preview: 'bg-zinc-100 text-zinc-800 border-zinc-200' },
  { name: 'Stone', value: 'stone', bg: 'bg-stone-500', preview: 'bg-stone-100 text-stone-800 border-stone-200' },
  { name: 'Neutral', value: 'neutral', bg: 'bg-neutral-500', preview: 'bg-neutral-100 text-neutral-800 border-neutral-200' }
];
...
const AdminStatusConfig: React.FC = () => {
  ...
  return (
    <div className="bg-transparent">
      <div className="max-w-full">{/* Removed header since it's now in the parent component */}
        ...
        {activeTab === 'statuses' && (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Add New Status</h3>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <ColorPicker 
                      selectedColor={newStatusColor} 
                      onColorSelect={setNewStatusColor} 
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  {newStatusLabel && (
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getColorClass(newStatusColor)}`}>
                        {newStatusLabel}
                      </span>
                    </div>
                  )}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {statuses.map((status, index) => (
                  <div key={status.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4 flex-1">
                        {/* Preview Badge */}
                        <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getColorClass(status.color)} min-w-0`}>
                      ...
                      <div className="flex items-center space-x-1 ml-4">
                        ...
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={status.isActive ? "M5 13l4 4L19 7" : "M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"} />
                          </svg>
                        </button>
                        {!status.isDefault && (
                          <button
        ...
        {activeTab === 'priorities' && (
          <div className="space-y-6">
            {/* Add New Priority */}
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Add New Priority</h3>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <div className="flex items-center justify-between">
                  {newPriorityLabel && (
                    <div className="flex items-center space-x-2">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Preview:</span>
                      <span className={`font-medium text-${newPriorityColor}-600 dark:text-${newPriorityColor}-400`}>
                        {newPriorityLabel}
                      </span>
                    </div>
                  )}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {priorities.map((priority, index) => (
                  <div key={priority.id} className="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4 flex-1">
                        {/* Preview */}
                        <div className={`font-medium text-${priority.color}-600 dark:text-${priority.color}-400 min-w-0 flex items-center`}>
                      ...
                      <div className="flex items-center space-x-1 ml-4">
                        ...
                        <button
                          ...
                          className={`p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600 ${
                            priority.isActive ? 'text-green-600 dark:text-green-400' : 'text-gray-400'
                          }`}
                          title={priority.isActive ? 'Disable' : 'Enable'}
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={priority.isActive ? "M5 13l4 4L19 7" : "M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"} />
                          </svg>
                        </button>
                        {!priority.isDefault && (
                          <button
