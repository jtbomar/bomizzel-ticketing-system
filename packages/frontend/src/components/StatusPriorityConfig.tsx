    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {statuses.map((status, index) => (
          <div key={status.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4 flex-1">
                {/* Preview */}
                <div className={`px-3 py-1 rounded-full text-sm font-medium border ${getColorClasses(status.color)}`}>
                  {status.label}
                </div>
                ...
                <div className="flex-1 grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={status.value}
                      onChange={(e) => updateStatus(status.id, { value: e.target.value.toLowerCase().replace(/\s+/g, '_') })}
                      className="w-full text-sm border border-gray-300 dark:border-gray-600 rounded px-2 py-1 dark:bg-gray-700 dark:text-white"
                    />
                  </div>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {priorities.map((priority, index) => (
          <div key={priority.id} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4 flex-1">
                {/* Preview */}
                <div className={`px-3 py-1 rounded text-sm font-medium text-${priority.color}-600 dark:text-${priority.color}-400`}>
                  {priority.label}
                </div>
                ...
                <div className="flex-1 grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => updatePriority(priority.id, { value: e.target.value.toLowerCase().replace(/\s+/g, '_') })}
                      className="w-full text-sm border border-gray-300 dark:border-gray-600 rounded px-2 py-1 dark:bg-gray-700 dark:text-white"
                    />
                  </div>
  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Status & Priority Configuration</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Configure ticket statuses and priorities for your team</p>
        </div>
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-96">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                A new status will be added with default settings. You can customize it after creation.
              </p>
        ...
        {showAddPriority && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-96">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                A new priority will be added with default settings. You can customize it after creation.
              </p>
              <div className="flex justify-end space-x-3">
                <button
