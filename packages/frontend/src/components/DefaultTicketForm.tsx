...
const DefaultTicketForm: React.FC<DefaultTicketFormProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      if (savedStatuses) {
        ...
        setStatuses(parsed.filter((s: StatusOption) => s.isActive).sort((a: StatusOption, b: StatusOption) => a.order - b.order));
      } else {
      ...
      if (savedPriorities) {
        ...
        setPriorities(parsed.filter((p: PriorityOption) => p.isActive).sort((a: PriorityOption, b: PriorityOption) => a.order - b.order));
      } else {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Default Ticket Layout</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Core Ticket Information (Required)</h3>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className={`w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white ${
                  errors.title ? 'border-red-300 focus:border-red-500' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500'
                }`}
                required
              />
              {errors.title && (
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                rows={4}
                className={`w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white ${
                  errors.description ? 'border-red-300 focus:border-red-500' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500'
                }`}
                required
              />
              {errors.description && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  className={`w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white ${
                    errors.status ? 'border-red-300 focus:border-red-500' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500'
                  }`}
                  required
                >
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  className={`w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white ${
                    errors.priority ? 'border-red-300 focus:border-red-500' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500'
                  }`}
                  required
                >
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Additional Information (Optional)</h3>
