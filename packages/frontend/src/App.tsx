...
function App() {
  return (
    <ThemeProvider>
      <AuthProvider>
        {/*
          Neither of these was mounted. useToast and useSocket both throw when
          their provider is missing, and CustomerDashboard calls
          useRealTimeNotifications on its first line, which uses both - so the
          customer dashboard threw before it rendered anything. AgentDashboard
          does not use those hooks, which is why this went unnoticed.
        */}
        <ToastProvider>
          <SocketProvider>
            <div className="App">
