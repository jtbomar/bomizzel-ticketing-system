        ...
        <div className="border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Manage your Kanban board columns and ticket statuses</p>
            </div>
            <button
        ...
        <div className="p-6">
            ...
            {statuses.map((status) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3">
                  {status.is_default && (
                    <span className="text-xs px-2 py-1 bg-blue-100 text-blue-800 rounded">Default</span>
                  )}
                  {status.is_closed && (
                    <span className="text-xs px-2 py-1 bg-green-100 text-green-800 rounded">Closed</span>
                  )}
                </div>
          ...
          {statuses.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500">No statuses found. Add your first status to get started.</p>
            </div>
          )}
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="flex items-center">
                  ...
                  />
                  <span className="text-sm text-gray-700">Mark as closed status (for resolved tickets)</span>
                </label>
              </div>
            </div>
