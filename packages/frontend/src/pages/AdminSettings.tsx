  ...
  const sections: SettingSection[] = [
    {
      ...
      items: [
        ...
        {
          name: 'Departments',
          description: 'Organize your teams into departments',
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Data Sharing',
          description: 'Control data access and sharing',
          path: '/admin/settings/data-sharing',
          icon: '🔗',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          name: 'Phone',
          description: 'Phone support settings',
          path: '/admin/settings/phone',
          icon: '📞',
        },
        {
          name: 'Chat',
          description: 'Live chat configuration',
        ...
        },
        {
          ...
          path: '/admin/settings/help-center',
          icon: '❓',
        },
        {
          name: 'Instant Messaging',
          description: 'IM integrations',
          path: '/admin/settings/instant-messaging',
          icon: '💭',
        },
        {
          name: 'Social',
        ...
        {
          name: 'Web Forms',
          description: 'Custom web forms',
          path: '/admin/settings/web-forms',
          icon: '📝',
        },
        {
          name: 'Community',
          description: 'Community forum settings',
          path: '/admin/settings/community',
          icon: '🌐',
        },
        {
          name: 'Agent Scripts',
          description: 'Predefined agent responses',
          path: '/admin/settings/agent-scripts',
          icon: '📜',
        },
        {
          name: 'Knowledge Base',
      ...
      items: [
        {
          ...
          description: 'Manage Kanban board columns',
        ...
        },
        {
          ...
          path: '/admin/settings/buttons',
          icon: '🔘',
        },
        {
          name: 'Modules And Tabs',
        ...
        },
        {
          ...
          description: 'Predefined ticket templates',
          path: '/admin/settings/ticket-templates',
          icon: '🎫',
        },
        {
          name: 'Time Tracking',
          description: 'Track time spent on tickets',
          path: '/admin/settings/time-tracking',
          icon: '⏱️',
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          name: 'Macros',
          description: 'Quick action macros',
        ...
        },
        {
          ...
          path: '/admin/settings/support-plans',
          icon: '📋',
        },
        {
          name: 'Schedules',
      ...
      items: [
        {
          ...
          path: '/data-management?tab=import',
          icon: '📥',
        },
        {
          name: 'Export',
          description: 'Export your data',
          path: '/data-management?tab=export',
          icon: '📤',
        },
        {
          name: 'Data Backup',
        ...
        },
        {
          ...
          path: '/admin/settings/recycle-bin',
          icon: '🗑️',
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        {
          name: 'Read Receipts',
          description: 'Email read tracking',
          path: '/admin/settings/read-receipts',
          icon: '👁️',
        },
        {
          name: 'Audit Logs',
        ...
        },
        {
          ...
          path: '/admin/settings/attachment-control',
          icon: '📎',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: '/admin/settings/my-information',
          icon: 'ℹ️',
        },
        {
          name: 'Preferences',
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        {filteredSections.length === 0 && (
          <div
            className={`text-center py-12 ${theme === 'dark' ? 'text-white/60' : 'text-gray-600'}`}
          >
