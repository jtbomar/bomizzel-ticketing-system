    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
            Streamline your customer support with a powerful, enterprise-grade ticketing system. No
            credit card required. No hidden fees. Just great support tools for your team.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Link
              to="/company-register"
              className="bg-primary-600 hover:bg-primary-700 text-white text-lg px-8 py-4 rounded-lg font-semibold transition-colors shadow-lg hover:shadow-xl"
            >
              Create Your Account
            </Link>
            <Link
              to="/register"
              className="bg-white hover:bg-gray-50 text-gray-900 text-lg px-8 py-4 rounded-lg font-semibold border-2 border-gray-300 transition-colors"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Organize and prioritize support requests with custom fields, statuses, and automated
                workflows
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Tailor the system to your needs with customizable fields, statuses, and ticket
                routing
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Track team performance and customer satisfaction with comprehensive dashboards and
                metrics
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Automatically convert emails to tickets and keep customers updated with email
                notifications
              </p>
            </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-primary-600 to-primary-700 rounded-2xl p-12 shadow-xl">
          ...
          <Link
            to="/company-register"
            className="inline-block bg-white hover:bg-gray-100 text-primary-600 text-lg px-8 py-4 rounded-lg font-semibold transition-colors shadow-lg"
          >
